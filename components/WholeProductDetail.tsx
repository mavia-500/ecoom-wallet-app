...
const WholeProductDetail:React.FC<WholeProductDetailProps> = ({products}) => {
    if (!products) {
        return (
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden w-full">
              ...
              <div className="p-4 sm:p-6">
                <h1 className="text-xl sm:text-2xl font-bold text-gray-800">{products?.title}</h1>
                <p className="text-gray-600 text-sm sm:text-base mt-2">{products?.description}</p>
                <div className="flex items-center mt-2 sm:mt-3">
                  <span className="text-xs sm:text-sm font-medium text-gray-500">Color: </span>
                  <span className="ml-2 text-xs sm:text-sm text-gray-700">{products?.color}</span>
                </div>
                <div className="flex items-center mt-2 sm:mt-3">
